...
export const education: Education[] = [
  {
    ...
    year: '2011 - 2014',
    summary:
      'Program intensiv de studiu dual axat pe Inginerie Software, Baze de Date și Management de Proiect.',
    description:
      'Pregătire profesională de 3 ani (Berufskolleg). A inclus un an de stagiu practic la Alpine Electronics R&D Europe GmbH, unde am elaborat teza finală: „Alpine Voltage Curve Editor” (Nota: Excelent / 1.0).',
  ...
  },
  {
    ...
    year: '2006 - 2009',
    summary:
      'Specializare dublă care oferă fundamente solide atât în matematică abstractă, cât și în informatică aplicată.',
    description:
      'Curriculum dual ce îmbină rigoarea matematicii teoretice cu abordările practice din informatică și ingineria software. Subiectele de bază au inclus: Structuri de Date, Inteligență Artificială, Sisteme de Baze de Date, Rețele de Calculatoare, Geometrie Computațională, Programare Logică și Funcțională și Modelare/Simulare Matematică.',
...
*În prezent caut un rol de Technical Lead axat pe ecosistemul Spring Boot și React. Sunt deschis la roluri în format Hibrid în regiunea Stuttgart, precum și către roluri cu program 100% de la distanță (Remote) din Germania.*`,
  ...
  skills: [
    ...
    'SQL/NoSQL',
    'IntelliJ IDEA',
    'Instrumente AI (Cursor, Windsurf, Antigravity, MCP)',
  ],
  certifications: [
...
export const about: AboutData = {
  ...
  lastName: 'NESI',
  description:
    'Technical Lead și Senior Full-Stack Engineer. Construiesc coloana vertebrală digitală a industriilor auto și fintech. Mă concentrez pe microservicii Spring Boot, front-end-uri React și pe accelerarea livrărilor de software enterprise printr-un flux de lucru asistat de IA.',
