...
export const education: Education[] = [
  {
    ...
    year: '2011 - 2014',
    summary:
      'Intensive dual study program focusing on Software Engineering, Database Systems, and Project Management.',
    description:
      '3-year vocational training (Berufskolleg). Included a one-year practical internship at Alpine Electronics R&D Europe GmbH with the thesis: "Alpine Voltage Curve Editor" (Graded: Excellent / Sehr gut).',
  ...
  },
  {
    ...
    year: '2006 - 2009',
    summary:
      'Dual major providing distinct foundations in both abstract Mathematics and Applied Computer Science.',
    description:
