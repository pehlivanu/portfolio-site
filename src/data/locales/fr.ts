...
export const education: Education[] = [
  {
    ...
    year: '2011 - 2014',
    summary:
      "Programme d'études intensif en alternance, centré sur le génie logiciel, les bases de données et la gestion de projet.",
    description:
  ...
  },
  {
    ...
    year: '2006 - 2009',
    summary:
      'Double cursus offrant des bases solides en mathématiques abstraites et en informatique appliquée.',
    description:
