...
*   Orientation de la stratégie technique à travers le prototypage et l'évaluation de nouvelles approches — vérification directe dans le code et animation d'ateliers d'équipe (par exemple sur le design REST/API-first, React moderne et Next.js, OpenRewrite, Dependabot, ainsi que l'évaluation de Spring Cloud Gateway comme remplacement de la passerelle sur mesure de DAT).`,
    tech: [
      { category: "Backend", skills: ["Java 17+", "Jakarta EE", "Spring Boot 3+", "Spring Cloud", "API REST", "OpenAPI", "Microservices", "SOA / SOAP", "WSDL"] },
...
*   Responsable des tests développeurs, de l'Assurance Qualité (JUnit, SonarQube) et des pipelines CI/CD pour les environnements de test et d'intégration (Git, Jenkins). Accompagnement de l'équipe de test pour les suites de bout en bout automatisées (Protractor, Cucumber) au sein d'équipes Scrum puis SAFe, en étroite collaboration avec les départements Frontend, Test et DevOps (Jira, Confluence, MS Teams).`,
    tech: [
      ...
      { category: "Bases de Données", skills: ["Oracle SQL", "PostgreSQL", "IBM DB2", "LDAP / Active Directory"] },
      { category: "CI/CD & DevOps", skills: ["Git", "SVN", "Jenkins", "Maven", "Docker", "IBM WebSphere (7 / 8.5)"] },
      { category: "Tests et Qualité", skills: ["JUnit", "SonarQube", "Protractor", "Cucumber", "OWASP / Tests de Pénétration"] },
      { category: "Outils", skills: ["IntelliJ IDEA", "Eclipse", "Rational Application Developer", "SharePoint", "Microsoft Flow", "Logic Apps", "Office 365", "Apache Directory Studio", "Postman", "Jira", "Confluence", "Cherwell", "MS Teams"] },
...
export const education = [
  {
    id: 1,
    type: "dual-study",
    studyField: "Études en Alternance",
    ...
    year: "2011 - 2014",
    summary: "Programme d'études intensif en alternance, centré sur le génie logiciel, les bases de données et la gestion de projet.",
    description: "Formation professionnelle de 3 ans (Berufskolleg). Inclut un an de stage pratique chez Alpine Electronics R&D Europe GmbH, validé par le mémoire : « Alpine Voltage Curve Editor » (Note : Excellent / 1,0).",
  ...
  },
  {
    ...
    location: "Timișoara, Roumanie",
    year: "2006 - 2009",
    summary: "Double cursus offrant des bases solides en mathématiques abstraites et en informatique appliquée.",
    description: "Cursus à double spécialisation qui allie mathématiques théoriques, informatique appliquée et génie logiciel. Les matières principales englobaient : Structures de Données, Intelligence Artificielle, Bases de Données, Réseaux Informatiques, Géométrie Algorithmique, Programmation Logique et Fonctionnelle, et Modélisation/Simulation Mathématique.",
...
*/
  ...
  },
  {
    ...
    tech: ["Next.js 14", "TypeScript 5", "MongoDB Atlas", "Tailwind CSS", "API OpenAI", "NextAuth", "Zod"],
...
export const about = {
  ...
  suffix: ".io",
  lastName: "NESI",
  description: "Tech Lead & Ingénieur Full-Stack Senior. Je bâtis l'épine dorsale numérique pour les secteurs de l'automobile et de la fintech. Spécialisé dans les microservices Spring Boot, les frontends React, et l'accélération de la livraison logicielle en entreprise grâce à des processus assistés par l'IA.",
