...
export const education = [
  {
    ...
    degree: "Informatician certificat",
    school: "GDS Schule 2",
    url: "https://gds2.de",
...
export const projects = [
  ...
  },
  {
    id: 4,
    title: "Filmpire",
    description: "O aplicație imersivă de descoperire a filmelor cu funcție de căutare prin comandă vocală (IA), filtrare pe categorii și un design modern și responsiv.",
